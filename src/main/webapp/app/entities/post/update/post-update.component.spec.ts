...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: 147 };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: 24674 }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: 456 };
      const tags: ITag[] = [{ id: 24935 }];
      post.tags = tags;

      const tagCollection: ITag[] = [{ id: 30976 }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: 456 };
      const blog: IBlog = { id: 17153 };
      post.blog = blog;
      const tag: ITag = { id: 21598 };
      post.tags = [tag];
