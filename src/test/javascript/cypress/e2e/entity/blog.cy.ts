...
describe('Blog e2e test', () => {
  ...
  const blogSample = { name: 'rural self-assured er', handle: 'how' };
  ...
  describe('new Blog page', () => {
    ...
    it('should create an instance of Blog', () => {
      cy.get(`[data-cy="name"]`).type('traumatic');
      cy.get(`[data-cy="name"]`).should('have.value', 'traumatic');

      cy.get(`[data-cy="handle"]`).type('townhouse destroy');
      cy.get(`[data-cy="handle"]`).should('have.value', 'townhouse destroy');
