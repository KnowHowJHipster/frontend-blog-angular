...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'vagrant', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2024-06-03T00:00:18.219Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('prang');
      cy.get(`[data-cy="title"]`).should('have.value', 'prang');
      ...
      cy.get(`[data-cy="date"]`).type('2024-06-03T00:26');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-06-03T00:26');
